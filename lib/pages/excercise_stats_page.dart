...
import 'package:gym_tracker_ui/pages/widgets/excercise_charts/excercise_set_char.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              ExcerciseSetChar(onSetClicked: _onSetClicked),
              if (_setInformation != null) const SizedBox(height: 16),
              if (_setInformation != null)
...
class SetInformationContainer extends StatelessWidget {
  const SetInformationContainer({super.key, required this.setInformation});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          SetInfomationHeader(title: formatter.format(setInformation.date)),
          Divider(
            height: 1,
            thickness: 1,
